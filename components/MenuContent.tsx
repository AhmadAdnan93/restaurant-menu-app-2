    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 scroll-smooth">
      ...
      <header className="relative -mt-16 md:-mt-24 px-4 sm:px-6 lg:px-8 z-10">
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4 md:gap-6">
              {restaurant.logo && (
                <div className="relative w-20 h-20 md:w-24 md:h-24 flex-shrink-0 rounded-xl overflow-hidden bg-gray-100">
                  <Image
              ...
              <div>
                ...
                {restaurant.description && (
                  <p className="text-sm text-gray-600 mt-1 max-w-md">{restaurant.description}</p>
                )}
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10">
              {restaurant.website && (
                <Link
                  ...
                  className="flex flex-col items-center gap-2 text-gray-700 hover:text-blue-600 transition-colors group"
                >
              ...
              {restaurant.phone && (
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-2 text-gray-700 hover:text-green-600 transition-colors group"
                >
              ...
              {restaurant.instagramUrl && (
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-2 text-gray-700 hover:text-pink-600 transition-colors group"
                >
